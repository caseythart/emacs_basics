;;; This is just Casey Hart's copying and pasting of wombat-theme.el, modifying a few things along the way. In particular, I had in mind to use it with ttl-mode.el. If at some point I have edited enough to warrant calling this my own, I'll replace the following comment with a nod to its predecessors.
...
(let ((class '((class color) (min-colors 89))))
  (custom-theme-set-faces
   'wombat-modified
   `(default ((,class (:background "#242424" :foreground "#f1f1f1"))))
   ...
   ;; Font lock faces
   `(font-lock-builtin-face ((,class (:foreground "#ee801c" :weight bold))))
   `(font-lock-comment-face ((,class (:foreground "#55dadd" :slant italic :weight semi-light))))
   `(font-lock-constant-face ((,class (:foreground "#b0e2ff"))))
   `(font-lock-function-name-face ((,class (:foreground "#ffd700"))))
   `(font-lock-keyword-face ((,class (:foreground "#d6d4ff" :weight bold))))
   `(font-lock-doc-face ((,class (:foreground "#a19deb"))))
   `(font-lock-string-face ((,class (:foreground "#9aff9a"))))
   `(font-lock-type-face ((,class (:foreground "#ffe7ba"))))
   `(font-lock-variable-name-face ((,class (:foreground "#d4c5ea"))))
   `(font-lock-warning-face ((,class (:foreground "#ff0000" :weight bold :slant italic))))
